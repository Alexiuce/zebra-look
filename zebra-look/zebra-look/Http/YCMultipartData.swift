...
/// 常见数据类型的`MIME Type`
public enum YCDataMimeType: String {
...
public class YCMultipartData {
    ...
    convenience init(data: Data, name: String, fileName: String, type: YCDataMimeType) {
